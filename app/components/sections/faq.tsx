                ...
                <div className="grid gap-y-12 px-2 lg:[grid-template-columns:1fr_auto]">
                    ...
                    <div className="divide-y divide-dashed sm:mx-auto sm:max-w-lg lg:mx-0">
                        ...
                        <div className="py-6">
                            ...
                            <p className="text-gray-400 my-4">Ikke nødvendigvis. I utgangspunktet er det førstemann i mål som vinner. Derimot er det en tidsstraff på 30 sekunder for hver gang man spyr. Merk at hvis man spyr på banen er man diskvalifisert.</p>
                        </div>
                    </div>
                </div>
            </div>
